...
public class signupThree extends JFrame implements ActionListener {
    ...
    signupThree(String formno) {
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-3236");
        ...
        JLabel F4dpin = new JLabel("Your 4 Digit Password");
        F4dpin.setFont(new Font("Raleway", Font.BOLD, 12));
        F4dpin.setBounds(100,400,300,20);
        add(F4dpin);
    ...
    public static void main(String[] args) {
        new signupThree("12345"); // Example form number
    }
}
